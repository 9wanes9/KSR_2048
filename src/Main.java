...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int row;
        while (true){
            System.out.println("Введите размерность игрового поля в ширину.");
            ...
            System.out.println("Например, 3, 4 или 5");
        }
        while (true){
            System.out.println("Введите размерность игрового поля в высоту.");
            while (!keyboardObserver.hasKeyEvents()) {
                //do nothing
            }
            KeyEvent event = keyboardObserver.getEventFromTop();
        ...
        System.out.println("Управление осуществляется стрелками, удачи");
        /**
